from pygments import formatters, highlight, lexer, lexers, token
...
def prettify_msg(msg):
    """Return a pretty-printed version of a SSDP message."""
    return highlight(str(msg), SSDPLexer(), formatters.TerminalFormatter())
